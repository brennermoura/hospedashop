...
const serviceLinks = [
  ...
  { label: 'E-mail Corporativo', href: '#contato' },
];
  ...
  return (
    <footer className="relative py-12 border-t border-white/5 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        <ScrollReveal>
          <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr] gap-10 pb-10 border-b border-white/5">
            <div>
              <a href="#top" className="flex items-center gap-2 mb-4" aria-label="Voltar para o início">
              ...
              <p className="text-slate-500 text-sm leading-relaxed max-w-sm mb-5">
                Criamos sites, lojas virtuais, sistemas e apps híbridos para empresas que precisam se apresentar melhor,
                vender com mais clareza e organizar processos digitais.
              </p>
        ...
        <ScrollReveal delay={100}>
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <a
                href="mailto:contato@hospeda.shop?subject=Solicitar%20Pol%C3%ADtica%20de%20Privacidade"
                className="text-slate-600 hover:text-slate-400 text-xs transition-colors"
              >
                Política de Privacidade
              </a>
              <a
                href="mailto:contato@hospeda.shop?subject=Solicitar%20Termos%20de%20Uso"
                className="text-slate-600 hover:text-slate-400 text-xs transition-colors"
              >
                Termos de Uso
              </a>
